 ...
 */
public class MqttPingSenderL implements org.eclipse.paho.client.mqttv3.MqttPingSender {
    ...
    private MqttPingSenderL that;
    private PendingIntent pendingIntent;
    private volatile boolean hasStarted = false;

    public MqttPingSenderL(MqttService service) {
        if (service == null) {
